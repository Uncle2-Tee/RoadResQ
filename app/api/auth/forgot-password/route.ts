...
export async function POST(request: Request) {
  try {
    ...
    const genericMessage =
      'If this email is registered, a password reset code has been created.';
    ...
    return Response.json({
      message:
        'Use the reset code shown below to set a new password.',
      expiresAt:
    ...
    return jsonError(
      'Unable to create password reset code',
      500
    );
  }
}